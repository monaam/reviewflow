      ...
      <div className="max-w-md w-full">
        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link to={routes.forgotPassword()} className="text-sm text-brand-600 hover:text-brand-500 font-medium">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to={routes.signup()} className="text-brand-600 hover:text-brand-500 font-medium">
              Sign up
            </Link>
          </p>
        </div>
