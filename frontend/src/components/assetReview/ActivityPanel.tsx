...
const EmojiPicker: FC<EmojiPickerProps> = ({ onSelect, onClose }) => {
  return (
    <div
      className="absolute left-0 bottom-full mb-1 z-50 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-1.5 flex gap-0.5"
