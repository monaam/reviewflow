...
export const PdfControls: FC<PdfControlsProps> = ({
  ...
  if (isMobile) {
    return (
      <div className="px-2 py-2 bg-gray-800 flex items-center justify-between relative z-20">
        {/* Page Navigation */}
        <div className="flex items-center gap-0.5">
          ...
          <div className="flex items-center gap-1 text-white text-xs">
            <input
              ...
              className="w-8 px-1 py-0.5 bg-gray-700 rounded text-center text-white text-xs focus:outline-none focus:ring-1 focus:ring-primary-500"
            />
        ...
        <div className="flex items-center gap-0.5">
          ...
          <button
            ...
            className={`p-1.5 rounded ${fitMode === 'width' ? 'bg-primary-600' : 'hover:bg-gray-700'}`}
          >
          ...
          <button
            ...
            className={`p-1.5 rounded ${fitMode === 'height' ? 'bg-primary-600' : 'hover:bg-gray-700'}`}
          >
